...
function bonus()
{
	...
	then
		...
		echo "NOTE: \033[0;32m49/51\033[0m"
	else
		echo "NOTE: \033[0;31m$nb / 49\033[0m"
	fi
}

function main()
{
	test invalid "error_file/error_" 29 "echo "error"" 0 error_put
